...
# UCL: package now has variants and lists gnutls and openssl as conditional dependencies
#      GnuTLS has precedence by default over OpenSSL if both libraries are installed.
import sys
